...
4. If the user proposes a **new project** without specifying a path (e.g. "vamos a hacer una calculadora"), automatically create it:
   ...
   ```
   This creates the project under `~/GlobalContext-Projects/<nombre>--<ruta>/` (the folder name includes the project name plus a path-derived suffix to avoid collisions and make it easy to find), registers it, and creates `.globalcontext.md`.
